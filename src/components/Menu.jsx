...
const Menu = () => {
    ...
    return (
        <section id="menu" aria-labbelledby="menu-heading">
            ...
            <div className="content">
                <div className="arrows">
                    <button className="text-left" onClick={() => goToSlide(currentIndex - 1)}>
                        ...
                        <img src="/images/right-arrow.png" alt="right-arrow"></img>
                    </button>
                    <button className="text-left" onClick={() => goToSlide(currentIndex + 1)}>
                        <span>{nextCocktail.name}</span>
                        <img src="/images/left-arrow.png" alt="left-arrow"></img>
                    </button>
                </div>
                <div className="cocktail">
                    <img src={currentCocktail.image} className="object-contain" alt="cocktail"></img>
                </div>
