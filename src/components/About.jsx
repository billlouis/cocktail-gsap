            ...
            <div className="mb-16 md:px-0 px-5">
                <div className="content">
                    ...
                    <div className="sub-content">
                        <p>
                            Every cocktail we serve is a reflecction of our obsession with detail - from the first muddle to the final garnish. That care is what turns a simple drink into something truly special.
                        </p>
                        <div>
